...
public final class ApiConstants {
    ...
    public static final String ENROLLMENTS_DROP_PATH = "/enrollments/drop";
    ...
    public static final String DROPPED_SUCCESS = "Dropped successfully";
    public static final String DROP_FAILED = "Failed to drop";
